...
all related information in step9_DEG_chip_gene.R  
...
筛选的条件是：Pvalue < 0.01, fold change >2 或者 < 2.   
...
筛选出各个week中，Pvalue < 0.01, fold change >2 或者 < 2.   的差异表达基因。  
...
举一个例子，如何看这张表    
比较有意思的一个基因：TTC22（研究很少），之前没有发现，他在colits时期，promoter就下调了。紧接着，在cancer时期，promoter和enhancer都下调了。这个基因有报道在结肠癌里面是RNA表达量下调的。 它对应的mouse的ensembl ID是ENSMUSG00000034919， 这个时候，去RNA表达的总表查看，我们会发现，2week~10week它的fold change是这样的：1.49736828906856， 0.746076670051349， -0.452608167736595， -0.420668045876659。基本是一个下调的趋势。  
