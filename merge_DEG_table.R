...
preprocess = function (count_table_path){
...
preprocess_2 = function (count_table_path ){
  d.raw <- read.delim(count_table_path, sep = "\t")
  d <- d.raw[rowSums(d.raw>3) > 2,]
...
select_data = function(count_table_path){
  data = preprocess(count_table_path = count_table_path)
  data2 = preprocess_2(count_table_path = count_table_path)
...
create_total_table = function(read_count_table_path, output_dir){
...
create_total_table(read_count_table_path = read_count_table_path, output_dir = output_dir)